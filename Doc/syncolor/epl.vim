" Vim syntax file
" Derrived from python.vim which is written/maintained by
...
syn keyword pythonStatement	break continue del do as
syn keyword pythonStatement	except finally
syn keyword pythonStatement	print raise
syn keyword pythonDef method def gen
syn keyword pythonStatement	return try import from None
syn keyword pythonStatement	global assert
syn keyword pythonStatement	lambda yield faryield far_yield_acceptor with
syn keyword pythonStatement	class self namespace
syn keyword pythonRepeat	for while
syn keyword pythonConditional	if else
syn keyword pythonStatement	and in is not or
syn match   pythonComment	"#.*$" contains=pythonTodo
syn match   pythonCOperator	"[-\(\)$;{}=%\[\]\.?:@]"
syn keyword pythonTodo		FIXME contained
