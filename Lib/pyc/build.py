...
t0=time()
compileFile ('re_tokenize.py', dynlocals=0, showmarks=SHOW, rrot3=RROT3, marshal_builtin=MARSHAL_BUILTIN,
	arch=ARCH)
...
compileFile ('symbols.py', dynlocals=0, showmarks=SHOW, rrot3=RROT3, constfiles=['consts.py'],
	 marshal_builtin=MARSHAL_BUILTIN, arch=ARCH)
compileFile ('pycmisc.py', dynlocals=0, showmarks=SHOW, rrot3=RROT3, marshal_builtin=MARSHAL_BUILTIN,
	arch=ARCH)
...
compileFile ('root.py', dynlocals=0, showmarks=SHOW, rrot3=RROT3, marshal_builtin=MARSHAL_BUILTIN,
	arch=ARCH)
compileFile ('gco.py', dynlocals=0, showmarks=SHOW, rrot3=RROT3, marshal_builtin=MARSHAL_BUILTIN, arch=ARCH)
compileFile ('exec_ast.py', dynlocals=0, showmarks=SHOW, rrot3=RROT3, marshal_builtin=MARSHAL_BUILTIN, arch=ARCH)
print time()-t0
